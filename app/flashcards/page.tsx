...
const FlashcardsPage = () => {
  ...
  const onDrop = (sourceSquare: string, targetSquare: string) => {
    try {
      ...
      if (isCorrectMove && currentPosition) {
        setRemembered(prev => [...prev, currentPosition.id]);
            ...
            <div className="flex-[0.35] space-y-4 min-w-[250px] max-w-[350px]">
              ...
              <div className="bg-[rgba(255,255,255,0.05)] border border-[rgba(255,255,255,0.3)] rounded-lg p-4">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-white/80 text-sm font-['Russo_One']">3. Mark if you remembered the position</p>
                  <p className="text-white/80 text-sm font-['Russo_One']">4. Use "Show Solution" if you're stuck</p>
                </div>
              </div>

              <div className="bg-[rgba(255,255,255,0.05)] border border-[rgba(255,255,255,0.3)] rounded-lg p-4">
                <h3 className="text-lg text-[rgba(36,245,228,0.84)] font-['Russo_One'] mb-3">Flashcards</h3>
                <div className="space-y-3">
                  <p className="text-white/80 text-sm font-['Russo_One']">Train your memory</p>
                  <p className="text-white/80 text-sm font-['Russo_One']">Track which positions you remember</p>
                </div>
              </div>
              ...
              <div className="bg-[rgba(255,255,255,0.05)] border border-[rgba(255,255,255,0.3)] rounded-lg p-4">
                ...
                <div className="space-y-2">
                  <Buttons
                    bUTTON="Remembered"
                    onLogInButtonContainerClick={markAsRemembered}
                    className="w-full !py-1 text-sm"
                  />
                  <Buttons
                    bUTTON="Not Remembered"
                    onLogInButtonContainerClick={markAsNotRemembered}
                    className="w-full !py-1 text-sm"
                  />
                  <Buttons
              ...
              {/* Progress */}
              <div className="bg-[rgba(255,255,255,0.05)] border border-[rgba(255,255,255,0.3)] rounded-lg p-4">
                <h3 className="text-lg text-[rgba(36,245,228,0.84)] font-['Russo_One'] mb-3">Progress</h3>
                <div className="space-y-2">
                  <div className="flex justify-between items-center">
                    <span className="text-white/80 font-['Russo_One']">Remembered:</span>
                    <span className="text-[rgba(36,245,228,0.84)] font-['Russo_One']">{remembered.length}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-white/80 font-['Russo_One']">Current Position:</span>
                    <span className="text-[rgba(36,245,228,0.84)] font-['Russo_One']">{currentIndex + 1}</span>
                  </div>
                </div>
              </div>
