...
const TrainingPage: NextPage = () => {
  ...
  const onPuzzleRushClick = useCallback(() => {
    router.push("/puzzle-rush");
  }, [router]);

  const onPuzzlesClick = useCallback(() => {
    router.push("/puzzles");
  }, [router]);

  const onFlashcardsClick = useCallback(() => {
                  ...
                  <div className="self-stretch flex flex-col items-center justify-start gap-[7.75rem] max-w-full mq850:gap-[3.875rem] mq450:gap-[1.938rem]">
                    <div className="relative z-[1]">
                      <p className="!m-0">
                        ...
                        Mode offers three different ways to practice your chess skills
                      </p>
                      <p className="!m-0">&nbsp;</p>
                      <p className="!m-0">
                        Choose your preferred training method below
                      </p>
                    </div>
                    <div className="self-stretch flex flex-row items-center justify-center !pt-[0rem] !pb-[0rem] !pl-[0rem] !pr-[0rem] box-border max-w-full">
                      <div className="flex flex-col items-center justify-start gap-[3.5rem] max-w-full mq450:gap-[1.75rem]">
                        <Buttons
                          ...
                          bUTTONColor="#FF0000"
                          secondWordColor="#fff"
                          onLogInButtonContainerClick={onPuzzleRushClick}
                        />
                        <Buttons
                          property1="Default"
                          logInButtonMarginTop="unset"
                          ...
                          bUTTONColor="#00FFA3"
                          secondWordColor="#fff"
                          onLogInButtonContainerClick={onPuzzlesClick}
                        />
                        <Buttons
                          property1="Default"
                          logInButtonMarginTop="unset"
                          ...
                          logInButtonWidth="24.375rem"
                          bUTTON="Flashcards"
                          bUTTONColor="rgba(36,245,228,0.84)"
                          secondWordColor="#fff"
                          onLogInButtonContainerClick={onFlashcardsClick}
                        />
                      </div>
                    </div>
                  </div>
